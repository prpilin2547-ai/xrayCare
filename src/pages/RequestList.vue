        ...
        <div class="main-box">
          ...
          <div class="box-body">
            ...
            <div class="inner-actions">
              <!-- ปุ่มไฟล์ภาพ -->
              <button
                v-if="selectedItem && selectedItem.imageData"
                class="btn btn-file shadow-sm"
...
// ข้อมูลเริ่มต้นในตาราง (mock หน้า frontend)
const items = ref([
  {
    id: 1,
...
const submitForm = () => {
  if (!selectedEquipment.value || !selectedRoom.value || !detail.value) return
...
<style scoped>
/* เหมือนเดิมทั้งหมด ตามที่คุณมีอยู่แล้ว */
